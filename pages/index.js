    ...
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-full minmd:w-4/5">
        ...
        {!isLoading && !nfts.length ? (
          <h1 className="font-Poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:l-0">
          ...
          <>
            ...
            <div className="mt-10">
              <div className="flexBetween mx-4 xs:mx-0 minlg:mx-8 sm:flex-col sm:items-start">
                ...
                <div
                  className="flex-2 sm:w-full flex flex-row
            sm:flex-col"
                >
                  <SearchBar
