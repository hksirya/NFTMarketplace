...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => {
  ...
  return (
    <div className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black-1 border-nft-gray-1 rounded-3xl flexx flex-col p-4 m-4">
      <div className="w-8 h-8 minlg:w-10 minlg:h-10 bg-nft-red-violet flexCenter rounded-full">
        <p className="font-Poppins text-white font-semibold text-base miglg:text-lg">
          {rank}
        </p>
      </div>
      ...
      <div className="my-2 flex justify-center">
        <div className="relative w-20 h-20 minlg:w-28 minlg:h-28">
          ...
          <div className="absolute w-6 h-6 minlg:w-7 minlg:h-7 bottom-2 -right-0">
            <Image
              src={images.tick}
              layout="fill"
              objectFit="contain"
